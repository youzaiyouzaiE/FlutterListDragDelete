...
class AppPageRoute extends MaterialPageRoute<String> {
  ...
  @override
  bool isPopGestureInProgress(PageRoute<dynamic> route)  => true;

  CupertinoPageRoute<String> get _cupertinoPageRoute {
    assert(_useRecuperationTransitions);
  ...
  bool get _useRecuperationTransitions {
  ...
  Widget buildTransitions(
    ...
    if (_useRecuperationTransitions) {
